                    ...
                    <%              
                        ...
                        if(visitantesMilitares.size() == 0){
                            ...
                            for(Visitante vis : visitantesMilitares){
                                ...
                                out.println("           </div>");
                                out.println("           <div class=\"form-group mr-2\">");                  
                                out.println("                   <button id="+vis.getIdentidade()+" type=\"submit\" name=\"btnAlterar\" class=\"btn btn-success\" data-toggle=\"modal\" data-target=\"#modalFormAttVisitante\" onclick=\"alteraVisitanteMilitar("+"'"+vis.getCpf()+"'"+");\">Alterar</button>");
                                out.println("           </div>");
                                out.println("       </div>");
                                out.println("   </td>");
                                out.println("</tr>");
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                            
                            <form class="container-fluid" action="controller.visitante/AtualizarVisitante" method="POST" name="formAtualizar">
                                <input type="hidden" class="form-control" id="txtCpfMilitarAtt" name="txtCpfMilitarAtt">
